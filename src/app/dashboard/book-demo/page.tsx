    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
      ...
      <div className="text-center space-y-3">
        ...
        <p className="text-slate-600 text-sm max-w-xl mx-auto">
          Experience our live offline & hybrid classroom methodology at Daffodil Smart City (DSC), Birulia, Savar, Dhaka-1216. Select your preferred course, date, and time slot below.
        </p>
      </div>
